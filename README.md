# CCNA Detailed Personal Study Notes

#  CCNA  Notes — Jeremy's IT Lab

Personal study notes for the **Cisco CCNA 200-301** certification.

Each day has my own written notes and the Packet Tracer lab file for that lesson.And if you want to get maximum output use both notes and labs for best understanding and concept clarity.
