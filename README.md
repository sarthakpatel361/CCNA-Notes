...
Each day has my own written notes and the Packet Tracer lab file for that lesson.And if you want to get maximum output use both notes and labs for best understanding.
